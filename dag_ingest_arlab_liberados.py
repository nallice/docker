...
def _request_url():
    ...
    url = f'http://ceacsul.com.br/w_relatorio_qlik/login.aspx?usu=NESS&senha=NESS@2019!&modelo=QLIK_ASSINADO&dt_i={dt_i}&dt_f={dt_f}'
    ...
    filename = f'RELATORIO_NESS_LIBERADOS{dt_i.day}-{dt_i.month}-{dt_i.year}_{dt_f.day}-{dt_f.month}-{dt_f.year}.csv'
