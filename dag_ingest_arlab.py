...
def _request_url():
    ...
    wasb_hook.load_file(filename_cad, container_name='raw/', blob_name=f'Arlab/Incremental/{year}/{month}/{day}/{filename_cad}')
    ...
    wasb_hook.load_file(filename_lib, container_name='raw/', blob_name=f'Arlab/Incremental/{year}/{month}/{day}/{filename_lib}')
