...
def _request_url():
    ...
    dt = datetime.date.today() - datetime.timedelta(days=61)
    ...
    wasb_hook.load_file(filename_cad, container_name='landing', blob_name=f'Arlab/{year}/{month}/{day}/{filename_cad}')
    ...
    wasb_hook.load_file(filename_lib, container_name='landing', blob_name=f'Arlab/{year}/{month}/{day}/{filename_lib}')
